...
import ContentSocialMedia from "./ContentSocialMedia";
import ContentReport from "./ContentReport";
import ContentPaidAd from "./ContentPaidAd";
import {
  FcSearch,
  FcAdvertising,
  FcMultipleDevices,
...
export default function MainService() {
  ...
  const contentMap = [
    <ContentSeo key="seo" />,
    <ContentSocialMedia key="socialmedia" />,
    <ContentPaidAd key="paidad" />,
    <ContentReport key="report" />,
  ];
